...
export default function ChatPage() {
  ...
  const { user, setUser, room, setRoom, setChannel, exitChat } =
    useGlobalState();
  ...
  if (isLoading) {
    return (
      <div className="container-fluid absolute h-full bg-dark flex items-center justify-center">
      ...
      <div className="row absolute w-full h-full">
        <section className="col-md-8 flex flex-row flex-wrap items-center content-center px-5">
          <div className="px-5 mx-5">
            <span
              className="block w-full h1 text-light"
              style={{ marginTop: -100 }}
            >
              <span>
